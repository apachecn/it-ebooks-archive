# 华章计算机科学丛书 NPM、PYPI、DockerHub 备份
...
```
npm install -g shuzi-sheji-hejisuanji-tixi-jiegou
shuzi-sheji-hejisuanji-tixi-jiegou <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/shuzi-tuxiang-chuli-yinan-jiexi
docker run -tid -p <port>:80 apachecn0/shuzi-tuxiang-chuli-yinan-jiexi
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g shuzi-tuxiang-chuli-yinan-jiexi
shuzi-tuxiang-chuli-yinan-jiexi <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/sousuo-yinqing-xinxi-jiansuo-shijian
docker run -tid -p <port>:80 apachecn0/sousuo-yinqing-xinxi-jiansuo-shijian
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g sousuo-yinqing-xinxi-jiansuo-shijian
sousuo-yinqing-xinxi-jiansuo-shijian <port>
# 访问 http://localhost:{port} 查看文档
```

## 算法：C语言实现第1-4部分：基础知识、数据结构、排序及搜索
...
```
docker pull apachecn0/suanfa-cyuyan-shixian-part1to4
docker run -tid -p <port>:80 apachecn0/suanfa-cyuyan-shixian-part1to4
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g suanfa-cyuyan-shixian-part1to4
suanfa-cyuyan-shixian-part1to4 <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/suanfa-cyuyan-shixian-part5
docker run -tid -p <port>:80 apachecn0/suanfa-cyuyan-shixian-part5
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g suanfa-cyuyan-shixian-part5
suanfa-cyuyan-shixian-part5 <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/suanfa-daolun-huazhang
docker run -tid -p <port>:80 apachecn0/suanfa-daolun-huazhang
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g suanfa-daolun-huazhang
suanfa-daolun-huazhang <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/suanfa-fenxi-daolun
docker run -tid -p <port>:80 apachecn0/suanfa-fenxi-daolun
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g suanfa-fenxi-daolun
suanfa-fenxi-daolun <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/suanfa-sheji-yufenxi-daolun
docker run -tid -p <port>:80 apachecn0/suanfa-sheji-yufenxi-daolun
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g suanfa-sheji-yufenxi-daolun
suanfa-sheji-yufenxi-daolun <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/wangluo-huazhang
docker run -tid -p <port>:80 apachecn0/wangluo-huazhang
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g wangluo-huazhang
wangluo-huazhang <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/wangluo-kexue-yuanli-yuyingyong
docker run -tid -p <port>:80 apachecn0/wangluo-kexue-yuanli-yuyingyong
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g wangluo-kexue-yuanli-yuyingyong
wangluo-kexue-yuanli-yuyingyong <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/web-fuwu-yuanli-yujishu
docker run -tid -p <port>:80 apachecn0/web-fuwu-yuanli-yujishu
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g web-fuwu-yuanli-yujishu
web-fuwu-yuanli-yujishu <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/web-gongcheng-shijianzhede-yanjiu-fangfa
docker run -tid -p <port>:80 apachecn0/web-gongcheng-shijianzhede-yanjiu-fangfa
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g web-gongcheng-shijianzhede-yanjiu-fangfa
web-gongcheng-shijianzhede-yanjiu-fangfa <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/weiji-jiekou-jishu-shiyan-jiaocheng
docker run -tid -p <port>:80 apachecn0/weiji-jiekou-jishu-shiyan-jiaocheng
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g weiji-jiekou-jishu-shiyan-jiaocheng
weiji-jiekou-jishu-shiyan-jiaocheng <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/wuxian-chuanganqi-wangluo-yuanli
docker run -tid -p <port>:80 apachecn0/wuxian-chuanganqi-wangluo-yuanli
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g wuxian-chuanganqi-wangluo-yuanli
wuxian-chuanganqi-wangluo-yuanli <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/x3d-jisuanji-tuxingxue
docker run -tid -p <port>:80 apachecn0/x3d-jisuanji-tuxingxue
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g x3d-jisuanji-tuxingxue
x3d-jisuanji-tuxingxue <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/x3d-youxi-vol2
docker run -tid -p <port>:80 apachecn0/x3d-youxi-vol2
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/x80x86-huibian-yuyan-jichu-jiaocheng
docker run -tid -p <port>:80 apachecn0/x80x86-huibian-yuyan-jichu-jiaocheng
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g xbalingxbaliu-huibian-yuyan-jichu-jiaocheng
xbalingxbaliu-huibian-yuyan-jichu-jiaocheng <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/x80x86-huibian-yuyan-yujisuanji-tixi-jiegou
docker run -tid -p <port>:80 apachecn0/x80x86-huibian-yuyan-yujisuanji-tixi-jiegou
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g xbalingxbaliu-huibian-yuyan-yujisuanji-tixi-jiegou
xbalingxbaliu-huibian-yuyan-yujisuanji-tixi-jiegou <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/xiandai-shujuku-guanli
docker run -tid -p <port>:80 apachecn0/xiandai-shujuku-guanli
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g xiandai-shujuku-guanli
xiandai-shujuku-guanli <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/xiandai-tixi-jiegoue-youhua-bianyiqi
docker run -tid -p <port>:80 apachecn0/xiandai-tixi-jiegoue-youhua-bianyiqi
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g xiandai-tixi-jiegoue-youhua-bianyiqi
xiandai-tixi-jiegoue-youhua-bianyiqi <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/xiandai-x86-huibian-yuyan-chengxu-sheji
docker run -tid -p <port>:80 apachecn0/xiandai-x86-huibian-yuyan-chengxu-sheji
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g xiandai-xbaliu-huibian-yuyan-chengxu-sheji
xiandai-xbaliu-huibian-yuyan-chengxu-sheji <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/xiandai-xinxi-jiansuo
docker run -tid -p <port>:80 apachecn0/xiandai-xinxi-jiansuo
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g xiandai-xinxi-jiansuo
xiandai-xinxi-jiansuo <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/xingshi-yuyan-yuzidongji-daolun
docker run -tid -p <port>:80 apachecn0/xingshi-yuyan-yuzidongji-daolun
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g xingshi-yuyan-yuzidongji-daolun
xingshi-yuyan-yuzidongji-daolun <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/xinxi-anquan-gongcheng
docker run -tid -p <port>:80 apachecn0/xinxi-anquan-gongcheng
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g xinxi-anquan-gongcheng
xinxi-anquan-gongcheng <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/xinxi-jiansuo-shixian-hepingjia-sousuo-yinqing
docker run -tid -p <port>:80 apachecn0/xinxi-jiansuo-shixian-hepingjia-sousuo-yinqing
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g xinxi-jiansuo-shixian-hepingjia-sousuo-yinqing
xinxi-jiansuo-shixian-hepingjia-sousuo-yinqing <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/xinxilun-bianma-yumimaxue
docker run -tid -p <port>:80 apachecn0/xinxilun-bianma-yumimaxue
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g xinxilun-bianma-yumimaxue
xinxilun-bianma-yumimaxue <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/xinxilun-jichu
docker run -tid -p <port>:80 apachecn0/xinxilun-jichu
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/xinxilun-yubianma-lilun-jianqiao-daxue-zhenti-jingjie
docker run -tid -p <port>:80 apachecn0/xinxilun-yubianma-lilun-jianqiao-daxue-zhenti-jingjie
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g xinxilun-yubianma-lilun-jianqiao-daxue-zhenti-jingjie
xinxilun-yubianma-lilun-jianqiao-daxue-zhenti-jingjie <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/xinxi-xitong-yuanli
docker run -tid -p <port>:80 apachecn0/xinxi-xitong-yuanli
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g xinxi-xitong-yuanli
xinxi-xitong-yuanli <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/xitong-fenxi-yusheji
docker run -tid -p <port>:80 apachecn0/xitong-fenxi-yusheji
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g xitong-fenxi-yusheji
xitong-fenxi-yusheji <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/xitong-fenxi-yusheji-daolun
docker run -tid -p <port>:80 apachecn0/xitong-fenxi-yusheji-daolun
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g xitong-fenxi-yusheji-daolun
xitong-fenxi-yusheji-daolun <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/xitong-fenxi-yusheji-jiaocheng
docker run -tid -p <port>:80 apachecn0/xitong-fenxi-yusheji-jiaocheng
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g xitong-fenxi-yusheji-jiaocheng
xitong-fenxi-yusheji-jiaocheng <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/xitong-fenxi-yusheji-minjie-diedai-fangfa
docker run -tid -p <port>:80 apachecn0/xitong-fenxi-yusheji-minjie-diedai-fangfa
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g xitong-fenxi-yusheji-minjie-diedai-fangfa
xitong-fenxi-yusheji-minjie-diedai-fangfa <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/xuniji-xitong-yujinchengde-tongyong-pingtai
docker run -tid -p <port>:80 apachecn0/xuniji-xitong-yujinchengde-tongyong-pingtai
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g xuniji-xitong-yujinchengde-tongyong-pingtai
xuniji-xitong-yujinchengde-tongyong-pingtai <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/yingyong-luoji
docker run -tid -p <port>:80 apachecn0/yingyong-luoji
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/yingyong-mimaxue-xieyi-suanfa-yucyuanchengxu
docker run -tid -p <port>:80 apachecn0/yingyong-mimaxue-xieyi-suanfa-yucyuanchengxu
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g yingyong-mimaxue-xieyi-suanfa-yucyuanchengxu
yingyong-mimaxue-xieyi-suanfa-yucyuanchengxu <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/yunjisuan-gainian-jishu-yujiagou
docker run -tid -p <port>:80 apachecn0/yunjisuan-gainian-jishu-yujiagou
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g yunjisuan-gainian-jishu-yujiagou
yunjisuan-gainian-jishu-yujiagou <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/yunjisuan-yufenbushi-xitong-congbingxing-chuli-daowulianwang
docker run -tid -p <port>:80 apachecn0/yunjisuan-yufenbushi-xitong-congbingxing-chuli-daowulianwang
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g yunjisuan-yufenbushi-xitong-congbingxing-chuli-daowulianwang
yunjisuan-yufenbushi-xitong-congbingxing-chuli-daowulianwang <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/yuyan-yujiqi-jisuanji-kexue-lilun-daolun
docker run -tid -p <port>:80 apachecn0/yuyan-yujiqi-jisuanji-kexue-lilun-daolun
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g yuyan-yujiqi-jisuanji-kexue-lilun-daolun
yuyan-yujiqi-jisuanji-kexue-lilun-daolun <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/yuyiwang-jichu-jiaocheng
docker run -tid -p <port>:80 apachecn0/yuyiwang-jichu-jiaocheng
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g yuyiwang-jichu-jiaocheng
yuyiwang-jichu-jiaocheng <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/zhuanjia-xitong-yuanli-yubiancheng
docker run -tid -p <port>:80 apachecn0/zhuanjia-xitong-yuanli-yubiancheng
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g zhuanjia-xitong-yuanli-yubiancheng
zhuanjia-xitong-yuanli-yubiancheng <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/zidongji-lilun-yuyan-hejisuan-daolun
docker run -tid -p <port>:80 apachecn0/zidongji-lilun-yuyan-hejisuan-daolun
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g zidongji-lilun-yuyan-hejisuan-daolun
zidongji-lilun-yuyan-hejisuan-daolun <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/zidong-wangluo-guanli-xitong
docker run -tid -p <port>:80 apachecn0/zidong-wangluo-guanli-xitong
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g zidong-wangluo-guanli-xitong
zidong-wangluo-guanli-xitong <port>
# 访问 http://localhost:{port} 查看文档
```
...
```
docker pull apachecn0/zuhe-shuxue-huazhang
docker run -tid -p <port>:80 apachecn0/zuhe-shuxue-huazhang
# 访问 http://localhost:{port} 查看文档
```
...
```
npm install -g zuhe-shuxue-huazhang
zuhe-shuxue-huazhang <port>
# 访问 http://localhost:{port} 查看文档
```