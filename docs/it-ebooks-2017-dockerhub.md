<!---
title: 计算机电子书 2017 DockerHub 备份
...
# 计算机电子书 2017 DockerHub 备份

## 下载

```
docker pull itebooks/it-ebooks-2017:part<num>
docker run -tid -p <port>:80 itebooks/it-ebooks-2017:part<num>
...
A Graduate Course in Applied Cryptography v0.3.pdf
A Second Course in Algorithms Lecture Notes (Stanford CS261).pdf
Abstract Interpretation.epub
...
part1
------
Advanced Topics in Computer Systems Reading List (UCB CS262A).pdf
...
An Introduction to Elm.epub
An Introduction to Statistical Learning.pdf
Analysis of Algorithms  Lecture Notes (Cornell CS6820).pdf
Android开发教程&笔记（张亚飞）.pdf
Apache Kudu 1.4.0 中文文档.epub
Apache Zeppelin 0.7.2 中文文档.epub
...
black Hat 议题摘要翻译.epub
Building Blocks for Theoretical Computer Science (UIUC CS173).pdf
C C++ socket编程教程：1天玩转socket通信技术.epub
C 参考手册 2017.12.20.epub
C#编程语言与面向对象基础精简教程（金旭亮）.pdf
C++ Best Practices.epub
C++ Qt5 范例开发大全.pdf
C++ 参考手册 第一部分 2017.12.20.epub
C++ 参考手册 第三部分 2017.12.20.epub
C++ 参考手册 第二部分 2017.12.20.epub
...
Calculus for Beginners (MIT).epub
CALCULUS MADE EASY.pdf
calculus with applications (MIT 18.013A).epub
...
Computational and Inferential Thinking (UCB Data8).epub
Computational Biology (MIT 6.047).pdf
...
------
c语言也能干大事.pdf
C语言基础教程（Lellansin）.epub
C语言深度剖析 解开程序员面试笔试的秘密.pdf
Dart 编码风格指南.epub
Data Structures and Functional Programming Lecture Notes (Cornell CS3110).epub
Data Structures and Object Oriented Design Lecture Notes (USC CSCI104).pdf
Data Structures Lecture Notes (UCB CS61b).pdf
Databricks Spark Reference Applications.epub
Deep Learning in Neural Networks - An Overview.pdf
Deep Learning Methods and Application.pdf
Deep Residual Learning for Image Recognition（七月在线DL翻译组2017.4）.pdf
DeepLearningAI 笔记 v5.1（黄海广）.pdf
...
Elasticsearch 5.4 中文文档.epub
Elasticsearch Java 手册.epub
Electromagnetics and Applications Lecture Notes (MIT 6.013).pdf
Electronic Feedback Systems (MIT 6.010).pdf
Ember.js 参考文档.epub
Excel 教程：实用技巧系列.epub
...
Exploring ES6.epub
EXT 中文手册（pjq）.pdf
Fast.ai Computational Linear Algebra Textbook.pdf
Foundations of Programming Languages Lecture Notes (CMU 15-312).pdf
FPGA实战手册.pdf
Functional Programming Lecture Notes (Chicago CS223).epub
Functional Systems In Haskell Lecture Notes(Stanford CS240h).epub
FuzzySecurity Windows Exploit 开发系列教程 1 ~ 8.epub
Gainlo 面试指南.epub
GDI+ SDK参考（翻译版本）.pdf
Generic Programming with Adjunctions.pdf
Getting Started with Storm 中文版.pdf
Go By Example 中文版.epub
Go 简易教程.epub
Graduate Computer Graphics (NYU CSCI-GA.2270-001).epub
Great Ideas in Theoretical Computer Science Lecture Notes (MIT 6.045).pdf
GTK+ 2.0 教程.epub
GTK+程序设计中文版.pdf
Hadoop 2.7.1 中文文档.pdf
Hadoop 笔记（PennyWong）.epub
HBase 0.97 中文文档.epub
HBuilder 使用教程.epub
Hibernate 开发指南（夏昕）.pdf
HomeKit App 开发指南.epub
Homotopy Type Theory Lecture Notes (CMU 15-819).pdf
How to Design Programs, Second Edition.epub
HTTP2 讲解.epub
Hyperledger 源码分析之 Fabric.epub
IDA Pro 5.4 中文帮助手册.chm
imobilebbs CodeSmith 教程.epub
imobilebbs Slick 教程.epub
Implementing a language with LLVM.epub
Information and Entropy (MIT 6.050J).pdf
Information Security Lecture Notes (Dixie IT4500).pdf
Intel® 64 and IA-32 Architectures Volume 1.pdf
...
Introduction to Communication, Control, and Signal Processing Lecture Notes (MIT 6.011).pdf
Introduction to EECS II Digital Communication Systems (MIT 6.02).pdf
Introduction to Electric Power Systems Lecture Notes (MIT 6.061).pdf
Introduction to Information Retrieval.pdf
Introduction to Nanoelectronics (MIT 6.701).pdf
Introduction to Probability (Dartmouth).pdf
...
Inventions and Patents Lecture Notes (MIT 6.901).pdf
iOS App Reverse Engineering.pdf
Java API 版本的Vert.x Core 手册.epub
Java for small teams.epub
...
JavaScript 轻量级函数式编程.epub
JavaScript基础教程（张陈斌）.pdf
JavaScript正则表达式迷你书.pdf
java基础教程（Java快车）.pdf
Java基础教程（李兴华）.pdf
...
Java面试宝典2016版.pdf
JS函数式编程指南.epub
kafka 中文文档 0.10.0.epub
Kali Linux Revealed.pdf
Keras 中文文档.epub
Kibana 5.2 中文文档.epub
Kubernetes Handbook.epub
Learning Deep Architectures for AI 中文版.pdf
Linux Shell脚本教程：30分钟玩转Shell脚本编程.epub
Linux 系统运维系列（unixhot）.7z
Linux 运维入门到高级全套系列.pdf
Linux入门教程（C语言编程网）.epub
...
Mathematics for Computer Science (MIT 6.042J).pdf
MATLAB Tutorial (MIT 10.34).pdf
...
MDN HTML 文档 20170730.epub
MDN HTTP 中文文档 20171202.epub
MDN JavaScript 参考文档 2017.2.6.epub
MDN 文件 API 中文文档.epub
Metasploit 新手指南.pdf
MFC入门教程：1天深入浅出MFC.epub
Microsoft可移植可执行文件和通用目标文件格式文件规范.pdf
Mininet 应用与源码剖析.epub
Mining Massive Data Sets Reading Material (Stanford CS246).pdf
MIT 线性代数笔记（子实）.pdf
MongoDB 3.4 中文文档 2017.5.6.epub
MQTT协议中文版.epub
MySQL 5.0存储过程.pdf
...
Objective-C基础教程：1天玩转Objective-C语法.epub
...
OllyDbg 完全教程.pdf
OpenCL 2.0 异构计算中文第三版.epub
OpenCV 中文文档.epub
OpenCV 官方教程中文版（Python）.pdf
OpenCV入门教程（于仕琪）.pdf
Operating System Lecture Notes (MIT 6.828).pdf
Operating Systems - Three Easy Pieces.pdf
Operating Systems and Middleware - Supporting Controlled Interaction.pdf
Operating Systems Lecture Notes (Stanford CS140).epub
Operating Systems Lecture Notes (UMD CMSC412).txt
Overcoming Intractability in Machine Learning Lecture Notes (Princeton COS598D).pdf
Pandas 0.19.2 中文文档 20170305.epub
Pandas 官方教程（10 分钟搞定 Pandas、Pandas 秘籍、学习 Pandas）.epub
...
PHP 调试技术手册.pdf
PHP2Python API 参考 2017.9.25.epub
PHP5面向对象初步（刀客羽朋）.pdf
PHP7内核剖析.epub
PHP内核介绍及扩展开发指南.pdf
PHP教程从零开始学设计模式（千峰教育）.pdf
PHP设计模式范例.epub
Plotly 绘图模块中文指南第1期.pdf
Principles of Computer System Design An Introduction Part II (MIT 6.004).pdf
Probabilistic Graphical Models Lecture Notes (CMU 10.708).pdf
Probabilistic Machine Learning (Duke STA561).pdf
...
Programming Languages Lecture Notes (NEU CS4400).epub
...
PyQt4 精彩实例分析.pdf
Python Data Science Handbook (Jupyter Notebook Version).pdf
Python 之旅.epub
Python 机器学习.epub
Python 自然语言处理 第二版 20170304.epub
Python 黑帽编程 1.1~4.2（玄魂工作室）.epub
...
React Bits 中文版.epub
React Enlightenment.epub
React In-depth.epub
React 入门教程.epub
React.js 小书 20170503.epub
Real-Time Programming Lecture Notes (Waterloo CS452).epub
Reinforcement Learning An Introduction (Complete Draft).pdf
Revel 中文文档.epub
RiceQuant 量化教程.pdf
Ruby 中文文档、RGSS 中文文档.epub
Scala 概述（瑞士洛桑联邦理工）.epub
Scapy 中文文档.epub
Scikit Learn 官方文档：示例.epub
Scikit-learn 秘籍.epub
seaborn统计绘图模块中文指南.pdf
Secure Programs HOWTO.pdf
Security Engineering — The Book V2.pdf
Serving Machine Learning Models.epub
Shark恒零基础破解教程之图文版.epub
SICP 2e (MIT 6.001).epub
Signals and Systems Lecture Notes (MIT 6.003).pdf
Software Analysis and Design I Lecture Notes (CUNY CSci135).pdf
Software Construction Lecture Notes (MIT 6.005).epub
...
Software Design and Implementation Lecture Notes (Washington CSE331).epub
Software Engineering for Internet Applications.epub
Software Foundations.epub
Spark 2.0.2 中文文档.epub
SploitFun Linux x86 Exploit 开发系列教程.epub
Spring 2.0 核心技术与最佳实践.pdf
Spring 2.3.2 开发简明教程（张勇）.pdf
Spring Boot 中文文档 1.5.2.epub
Spring Boot 入门教程（翟永超）.epub
Spring Cloud 教程（翟永超）.epub
Spring MVC 4.2.4.RELEASE 中文文档.epub
Spring 快速入门教程（Hantsy）.pdf
Spring-Data-Elasticsearch 中文文档.epub
SQL for Web Nerds.epub
SQLAlchemy 1.1 Documentation.epub
SSDB 数据库使用手册.epub
Stanford CS109 Probability for Computer Scientists Lecture Notes.pdf
...
Storm 1.1.0 中文文档.epub
Street-Fighting Mathematics Lecture Notes (MIT 6.009).pdf
Sublime Text 中文文档、使用手册.epub
Swoole 中文文档.epub
SymPy 1.1.1 documentation.epub
System Security Lecture Notes (StonyBrook CSE509).pdf
T00ls技术文章350篇.7z
TensorFlow 官方文档中文版.epub
TensorFlow 教程（Hvass）.epub
The Art of Approximation in Science and Engineering Lecture Notes (MIT 6.055J).pdf
The Art of Data Science.epub
the beginner's guide to idapython 中文版.pdf
The Datacenter as a Computer.pdf
The Design and Analysis of Algorithms.pdf
The Elements of Statistical Learning 2e.pdf
The Matrix Cookbook.pdf
The Scheme Programming Language 4e.epub
...
Three.js 入门指南.epub
Tiny Python & ES6 Notebook.epub
TIPI：深入理解PHP内核.pdf
Transition to OO Programming Lecture Notes (Cornell CS1130).pdf
tushare函数手册中文版.pdf
TutorialsPoint Apex 教程.epub
Type Systems（Luca Cardelli）.pdf
TypeScript Deep Dive.epub
UCB CS61AS SICP with Racket.epub
UIUC Crowd-Sourced System Programming Book.epub
...
Web Hacking 101 中文版.epub
Web Hacking 101.pdf
Windows Exploit 开发教程（Massimiliano Tomassoli）.epub
Windows XP 2003 堆溢出实战.pdf
Windows 平台下的堆溢出、格式化字符串漏洞利用技术.pdf
Windows编程入门：Windows程序设计1小时入门教程.epub
WordPress 主题教程.pdf
WordPress 高级教程（晋级版）.pdf
xv6 中文文档.epub
YAF 用户手册.epub
Zetcode PyQt4 教程.epub
zw Python 量化分析课件.7z
《SciPy and NumPy》中文精要.pdf
【spark论文】大型集群上的快速和通用数据处理架构（修正版）.pdf
一种针对特定网站类别的网页指纹识别方法 （南邮 CN105281973A）.pdf
七月在线 DL 论文翻译组译文 2017.3.7z
三月机器学习在线班笔记（frank_shaw）.pdf
不周山之读薄 CSAPP.epub
...
从零开始学 ReactJS（ReactJS 101）.epub
代码能有多难？——简单的网页代码书.epub
以太坊白皮书.pdf
以太坊黄皮书.pdf
传智播客 mybatis 框架课程讲义.pdf
你好，C++！.pdf
使⽤ MXNet Gluon 来动⼿学深度学习 0.4.pdf
...
关于C++编程的42条建议.pdf
写给人类的机器学习.epub
初等算法（算法新解）0.6180339887498949.pdf
利用 Python 进行数据分析 第二版 中文精要.pdf
前端开发者指南（2017）.epub
剑指 Offer 题解（JeanCheng）.epub
北京动力节点 Reyco郭 Spring4 SpringMVC4 Mybatis3 讲义.7z
...
区块链技术指南 0.9.0.epub
单片机教程（C语言编程网）.epub
台湾大学林轩田机器学习基石笔记（红色石头）.epub
史上最强的 WordPress 初级-中级-高级教程.pdf
吾爱破解『我是用户』破解实战.epub
商朝子的解密入门教学.epub
增强学习导论中文版（RLAI）2~10.pdf
大道至简（周爱民）.pdf
天书夜读（试读版）.pdf
如何学python（李三思）.epub
...
微学苑 Java 教程.epub
微学苑设计模式教程.epub
微软官方 .NET Core 指南 20171224.epub
微软官方 .NET 指南 20171224.epub
微软官方 C# 指南 20171224.epub
微软官方 F# 指南 20171224.epub
微软官方 VB  指南 20171224.epub
我的数学分析积木（修订版）.pdf
我的职业是前端工程师.pdf
挑战30天C++入门极限.pdf
换个角度看线性代数（风萧萧）.pdf
探索 ES2016 与 ES2017.epub
探索 ES6（未完）.epub
操作系统教程（C语言编程网）.epub
...
线性代数讲义（武汉大学 马涛）.pdf
组合语言之艺术.epub
统计思维：程序员数学之概率统计 · GitBook.url
绿盟 Android APP 测试指南.pdf
绿盟 iOS APP 测试指南.pdf
编程随想博客匿名术文集 2009~2015.epub
莫烦 Git 教程 2017.5.10.epub
莫烦 Python 教程 2017.5.10.epub
莫烦数据处理教程 2017.5.10.epub
莫烦机器学习教程 2017.5.10.epub
计算机程序的思维逻辑（Java 描述）.epub
...
随机过程讲义（中科院 孙应飞）.pdf
随机过程讲义（南开大学）.pdf
雪城大学计算机与网络安全讲义（CIS643&644）v0.1.epub
零基础入门深度学习（hanbingtao）.pdf
非监督特征学习与深度学习 中文教程（UFLDL）.pdf
面向对象的脚本语言Ruby.epub
飞龙的安卓逆向教程 v1.0.epub
